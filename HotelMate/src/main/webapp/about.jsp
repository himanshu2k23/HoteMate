...
.section-container {
	padding: 60px 0;
	background:
		url("https://mediadirhub.com/samples/abstract-white-background-with-squares.jpg")
							...
							<div class="col-12 col-md-7 d-flex align-items-center">
								<div class="mw-100">
									<div id="heading"
										...
										HotelMate Booking Platform</div>
									<div id="summary"
										class="text-break elements textHtml text-start section-subheading">
										Streamlined hotel booking platform for easy reservations with
										Room Reservation feature.</div>
									<div class="">
							...
							<div class="col-12 col-md-5">
								<div class="position-relative w-100 ai-generated"
									...
									<img id="banner" class="elements image w-100"
										...
										alt=""
										style="background: url('https://mediadirhub.com/ai-generated/code/hotel-booking-platform/hotelmate-booking-platform.png') center center/cover no-repeat; border-radius: 0px;">
								</div>
							</div>
						</div>
					</div>
