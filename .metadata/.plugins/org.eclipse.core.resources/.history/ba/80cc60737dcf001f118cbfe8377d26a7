...
.banner {
	position: relative;
	background-image:
		url("https://r.mobirisesite.com/836216/assets/images/photo-1625244695851-1fc873f942bc.jpeg");
...
<div class="banner">
	...
	<div class="banner-content text-center">
		<h1>
			<span class="line1">Book Comfortably,</span> <span class="line2">Travel
				Seamlessly</span>
		</h1>
		<p>
			HotelMate brings you the best hotels across India with easy booking
			and reliable comfort for every journey. <br> Enjoy a stay that
			feels like home, wherever you go.
		</p>
		<div class="mt-4 d-flex justify-content-center">
			<a href="signup.jsp" class="btn btn-primary">Get Started</a> <a
				href="aboutUs.jsp" class="btn btn-outline-light">About Us</a>
		</div>
	</div>
</div>
